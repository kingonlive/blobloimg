...
public class ImgData {
    ...
    String pi;
    String is;
    List<ReplaceUrlObject> replaceUrl;
    String hasThumbData;
    int bdSetImgNum;
    int partnerId;
    //1970-01-01 08:00
    String bdImgnewsDate;
    //高清欧美性感<strong>美女<\/strong>壁纸【1280x1024】
    String fromPageTitle;
    //高清欧美性感美女壁纸【1280x1024】
    String fromPageTitleEnc;
    String bdSourceName;
    String bdFromPageTitlePrefix;
    int isAspDianjing;
    String token;
    String imgType;
    String cs;
    ...
    public List<ReplaceUrlObject> getReplaceUrl() {
        return replaceUrl;
    }

    public void setReplaceUrl(List<ReplaceUrlObject> replaceUrl) {
    ...
    public String toString() {
        return "ImgData{" +
                ...
                ", hasThumbData='" + hasThumbData + '\'' +
                ", bdSetImgNum=" + bdSetImgNum +
                ", partnerId=" + partnerId +
                ", bdImgnewsDate='" + bdImgnewsDate + '\'' +
                ", fromPageTitle='" + fromPageTitle + '\'' +
                ", fromPageTitleEnc='" + fromPageTitleEnc + '\'' +
                ", bdSourceName='" + bdSourceName + '\'' +
                ", bdFromPageTitlePrefix='" + bdFromPageTitlePrefix + '\'' +
                ", isAspDianjing=" + isAspDianjing +
                ", token='" + token + '\'' +
                ", imgType='" + imgType + '\'' +
                ", cs='" + cs + '\'' +
                ", os='" + os + '\'' +
                ...
                ", simid_info=" + simid_info +
                ", face_info=" + face_info +
                ", xiangshi_info=" + xiangshi_info +
                ", adPicId='" + adPicId + '\'' +
